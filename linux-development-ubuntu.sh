...
json="`echo "$json" | jq '."java.configuration.runtimes".[0]."name"="JavaSE-1.8"'`"
json="`echo "$json" | jq '."java.configuration.runtimes".[0]."path"="'$java8_dir'"'`"
json="`echo "$json" | jq '."java.configuration.runtimes".[1]."name"="JavaSE-14"'`"
json="`echo "$json" | jq '."java.configuration.runtimes".[1]."path"="'$java14_dir'"'`"
json="`echo "$json" | jq '."java.configuration.runtimes".[1]."default"=true'`"
